package aula14.mapas.exemplosgerais;

import java.util.HashMap;
import java.util.Map;

public class Exemplo03MetodoRemove {
	...
	public static void main(String[] args) {
		...
		alunos.remove(222222);

		if (alunos.containsKey(222222)) {

			System.out.println("Aluno existente na base de dados.");

		} else {

			System.out.println("Cadastro não encontrado na base de dados.");
		}
	}
}
